...
namespace PhoenixKineticistElements.Components
{
    ...
    public class AbilityRestrictionWildTalentCastCapper : BlueprintComponent, IAbilityRestriction
    {
        ...
        protected int GetRank(UnitEntityData owner)
        {
            int ranks = 0;
        ...
        protected int GetCap(UnitEntityData owner)
        {
            int actualcap;
            if (useCapResource)
            {
